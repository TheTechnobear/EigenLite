...
Active tasks live in `ai/work/`. Use `/task-new` to create a task and `/task-update` to record decisions or close it out. Closed tasks move to `ai/archive/`. Cross-references are maintained in `docs/roadmap.md` and `docs/known-issues.md`.
